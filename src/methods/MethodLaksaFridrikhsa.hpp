...
class MethodLaksaFridrikhsa: public Method{
	...
	public: vector<double> calculateFlow(double Bx, double Ul[], double Ur[], double& maxs){
		double Bdl[]={0,0,0};
		double Bdr[]={0,0,0};
		double Bdx = 0;

		return calculateFlow(Bx, Bdx, Ul, Ur, Bdl, Bdr, maxs);
	}
	...
	private: double getMaxSpeed(double Ul[], double Ur[]){
