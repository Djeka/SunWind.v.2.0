...
class Cell : public CellInt //Cell - Rectengular Parallepiped Cell
{
	...
	protected: int mark; //0 - internal cell; 1 - border free cell;
	...
	public: double getB(int axis){
		return 0.5 * (getSide(axis, Cell::BACKWARD_SIDE)->getB() + getSide(axis, Cell::FORWARD_SIDE)->getB());
	}
